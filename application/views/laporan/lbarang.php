...
<div role="main">
  <div class="">
	...
	<div class="pull-right ">
		<a href="<?php echo  base_url();?>./index.php/utama/report_csv_barang"><i class="ace-icon fa fa-file-excel-o fa-2x green"></i></a>&nbsp;&nbsp;
		<a href="<?php echo  base_url();?>./index.php/utama/report_pdf_barang"><i class="ace-icon fa fa-file-pdf-o fa-2x red"></i></a>&nbsp;&nbsp;
	</div>
	</div>
