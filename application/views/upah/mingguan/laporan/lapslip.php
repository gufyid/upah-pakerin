					...
					<div class="col-xs-8">
						<form class="form-horizontal" method="POST" enctype="multipart/form-data" id="form_lt">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input class="form-control date-picker" Name="periode_awal" id="periode_awal" type="text" data-date-format="yyyy-mm-dd" placeholder="Periode Awal" autocomplete="off" required />
									<span class="help-inline col-xs-12 col-sm-7">
									</span>
								</div>
								<div class="col-sm-3">
									<input class="form-control date-picker" Name="periode_akhir" id="periode_akhir" type="text" data-date-format="yyyy-mm-dd" placeholder="Periode Akhir" autocomplete="off" required />
									<span class="help-inline col-xs-12 col-sm-7">
									</span>
								</div>
							</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#proses').click(function() {
				// if (confirm('Yakin mau proses Cetak Slip Gaji?') == true) {
				// 	$.ajax({
				// 		type: 'POST',
				// 		url: '<?php echo base_url() . "index.php/mingguan/proses_slip" ?>',
				// 		data: {
