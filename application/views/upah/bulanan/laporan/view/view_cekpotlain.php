...
<div role="main">	
	...
	<div class="row">
	<div class="col-xs-12">
			<h4 class="text-center">DAFTAR POT. LAIN-LAIN KARYAWAN BULANAN PT. PAKERIN  <br/>
			...
			<table class="display" border="1" style="width:100%">
				...
				<?php 
					...
					foreach($data as $d)
					{
						...
						$seksi   = $d['seksi'];
						$nmseksi = $d['nama'];
						$sql = "SELECT a.*,b.nama,b.seksi,c.nama AS nmseksi ,d.pot_t3m FROM t_premi_bulanan a
							...
							WHERE a.bulan='$bulan' AND a.tahun='$tahun' AND d.bulan='$bulan' AND d.tahun='$tahun' and b.seksi='$seksi' AND d.pot_t3m != 0  	ORDER BY c.nama ";
						...
						if($potlain)
						{
							...
							{	
									...
									echo "<tr>";
										...
										echo "<td class=text-center>".number_format($p['pot_t3m'])."</td>";
										echo "<td class=text-center>".number_format($p['pot_t3m'])."</td>";
									echo "</tr>";
